<!doctype html>
<html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><title>peer-info - Documentation</title><link href="https://fonts.googleapis.com/css?family=Roboto+Mono:400,500|Roboto:300,500,700" rel="stylesheet"/><style>body{margin: 0;
padding: 0;
color: #000;
...
font-weight: bold;}.hljs-deletion{background: #fdd;}.hljs-addition{background: #dfd;}.hljs-emphasis{font-style: italic;}.hljs-strong{font-weight: bold;}</style><div style="margin-bottom:104px;" data-radium="true"><h1 data-radium="true"><a class="anchor" name="intro"></a>Intro</h1><div><p>Installable via  <code>npm install --save peer-info</code>, it can also be used directly in the browser.</p>
<h2>Download</h2>
<p>The source is available for download from <a href="https://github.com/libp2p/js-peer-info.git">GitHub</a>. Alternatively, you can install using npm:</p>
<pre class='hljs'>$ npm install --save peer-info</pre>
<p>You can then <code>require()</code> peer-info as normal:</p>
<pre class='hljs'><span class="hljs-keyword">const</span> peerInfo = <span class="hljs-built_in">require</span>(<span class="hljs-string">'peer-info'</span>)</pre>
<h2>In the Browser</h2>
<p>Peer-info should work in any ES2015 environment out of the box.</p>
<p>Usage:</p>
...
<p>The portable versions of peer-info, including <code>index.js</code> and <code>index.min.js</code>, are included in the <code>/dist</code> folder. Peer-info can also be found on <a href="https://unpkg.com">unkpkg.com</a> under</p>
<ul>
<li><a href="https://unpkg.com/peer-info/dist/index.min.js">https://unpkg.com/peer-info/dist/index.min.js</a></li>
<li><a href="https://unpkg.com/peer-info/dist/index.js">https://unpkg.com/peer-info/dist/index.js</a></li>
</ul>
